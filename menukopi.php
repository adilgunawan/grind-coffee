    ...
    <div class="pilihanitem">
      ...
      ?>
        ...
        <!-- <div class="box">
          ...
          <h1>Coconut Latte</h1>
          <h5>Kekayaan Kopi dengan Kelapa Murni</h5>
          <h2>RP. 30.000.00</h2>
          <div class="tersisa">
        ...
        <div class="box">
          ...
          <h1>Espresso Machiatto</h1>
          <h5>Espresso Autentik dengan Cita Rasa Khas</h5>
          <h2>RP. 30.000.00</h2>
          <div class="tersisa">
            <h6>Tersisa 20 buah</h6>
            <i class="fa-regular fa-square-minus"></i>
      ...
      <!-- <div class="itemproducts">
        <div class="box">
          ...
          <h1>Avocado Coffee</h1>
          <h5>Sensasi Kopi dengan Alpukat Yang Lezat</h5>
          <h2>RP. 30.000.00</h2>
          <div class="tersisa">
            <h6>Tersisa 20 buah</h6>
            <i class="fa-regular fa-square-minus"></i>
